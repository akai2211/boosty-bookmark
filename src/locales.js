const locales = {
    ru: {
      ...
      notify_webdav_permission_page_opened: 'Открыли окно для доступа к серверу. Разрешите доступ и снова нажмите «Обновить».',
      welcome_title: 'Спасибо, что установили! 🧡',
      welcome_body: 'Расширение ещё дорабатывается. Если что-то пойдёт не так или появятся идеи — напишите мне на Boosty, я постараюсь помочь.',
      welcome_thanks: 'Приятного пользования!',
      welcome_boosty_btn: 'Мой Boosty',
      welcome_close_btn: 'Закрыть',
    ...
    en: {
      ...
      notify_webdav_permission_page_opened: 'Opened a window to grant server access. Allow it and click “Update” again.',
      welcome_title: 'Thanks for installing! 🧡',
      welcome_body: 'The extension is still a work in progress. If something goes wrong or you have an idea, message me on Boosty — I\'ll try to help.',
      welcome_thanks: 'Enjoy!',
      welcome_boosty_btn: 'My Boosty',
