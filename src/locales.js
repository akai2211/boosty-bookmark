const locales = {
    ru: {
      ...
      settings_webdav_url_hint: 'Для локального сервера (NAS) по HTTP укажите протокол явно: http://… Иначе подставляется https://',
      ...
      settings_sync_title_from_url_label: 'Переход по тегам на Boosty',
      settings_sync_title_from_url_desc: 'Автоматически открывать детальный вид тайтла в сайдбаре при выборе тега на странице Boosty.',
      ...
      notify_sync_title_from_url_on: 'Автопереход по тегам включен',
      notify_sync_title_from_url_off: 'Автопереход по тегам выключен',
      ...
      import_dialog_title: 'Импорт прогресса',
      import_dialog_text: 'Как применить данные из архива?',
      import_dialog_merge_btn: 'Объединить с текущим',
      import_dialog_merge_hint: 'Безопасно: данные сольются (последнее изменение побеждает).',
      import_dialog_replace_btn: 'Заменить всё',
      import_dialog_replace_hint: 'Текущий прогресс будет перезаписан данными из архива.',
      ...
      error_webdav_conflict: 'Облако изменилось во время синхронизации, повторяю слияние…',
    ...
    en: {
      ...
      settings_sync_title_from_url_label: 'Auto-navigate by tags on Boosty',
      settings_sync_title_from_url_desc: 'Automatically open detailed title view in the sidebar when choosing a tag on Boosty.',
      ...
      notify_sync_title_from_url_on: 'Auto-navigate by tags enabled',
      notify_sync_title_from_url_off: 'Auto-navigate by tags disabled',
      ...
      import_dialog_title: 'Import progress',
      import_dialog_text: 'How should the archive data be applied?',
      import_dialog_merge_btn: 'Merge with current',
      import_dialog_merge_hint: 'Safe: data is merged (last change wins).',
      import_dialog_replace_btn: 'Replace all',
      import_dialog_replace_hint: 'Current progress will be overwritten with the archive data.',
      ...
      error_webdav_conflict: 'Cloud changed during sync, retrying merge…',
